...
import {IERC721, IERC721Errors} from "../ERC721AllFiles/Interface.sol";
import {IERC721Receiver} from "../ERC721AllFiles/IERC721Receiver.sol";
import {IERC721Metadata} from "../ERC721AllFiles/IERC721Metadata.sol";
import {Context} from "../ERC721AllFiles/Context.sol";
import {Strings} from "../ERC721AllFiles/Strings.sol";
import {ERC165} from "../ERC721AllFiles/ERC165.sol";
import {IERC165} from "../ERC721AllFiles/IERC165.sol";
import {Ownable} from "../ERC721AllFiles/Ownable.sol";
    ...
    Ownable
{
    ...
    //     AllTokenIDsOfAddress[to].push(tokenId);
    //     saveToOwnershipHistory(tokenId, msg.sender, to);
    // }
   ...
   // contract auctionContract is ERC721 {
    ...
    function makebid(
        ...
        require(
            msg.sender.balance >= bid && msg.value >= bid ,
